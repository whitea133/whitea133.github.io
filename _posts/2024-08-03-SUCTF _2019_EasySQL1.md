...
后面加入的`|| flag `一定程度上提高了题目的难度，但是知道是非经典式SQL语句。**这种情况如果回显的结果只有真或是假，就可以知道SQL语句拼接了一个逻辑运算符**。可以多测试几个参数，通过判断逻辑运算结果，也可以猜出是进行了一次**或运算** `||`
...
<div align=center><img src="../images/2024/08/03/2019EasySQL_1.png" alt="2019EasySQL_1" border="0" width="80%" height="60%"></div>
...
<div align=center><img src="../images/2024/08/03/2019EasySQL_2.png" alt="2019EasySQL_2" border="0" width="80%" height="60%"></div>
